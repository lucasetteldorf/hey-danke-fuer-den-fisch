...
public class BaselineTest {
  ...
  void testRandomVsRandom() {
    ...
    for (int i = 0; i < NUMBER_OF_GAMES; i++) {
      ...
      game.start();
      DataWriter.writeDataLine("/Users/Lucas/thesis-data/random-vs-random-3.csv", players);
    }
  }
  ...
  void testRandomVsGreedy() {
    ...
    for (int i = 0; i < NUMBER_OF_GAMES; i++) {
      ...
      game = new Game(players);
      game.start();
      DataWriter.writeDataLine("/Users/Lucas/thesis-data/random-vs-greedy-3.csv", players);
    }
  }
}
